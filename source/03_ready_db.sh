...
#Mysql secure installation replications
mysql -u ${DBROOT_USER} -p${DBROOT_PASS} -h ${MYBB_DATABASE_HOST} -P ${MYBB_DATABASE_PORT} -e "DROP USER ''@'localhost'"
mysql -u ${DBROOT_USER} -p${DBROOT_PASS} -h ${MYBB_DATABASE_HOST} -P ${MYBB_DATABASE_PORT} -e "DROP USER ''@'$(hostname)'"
mysql -u ${DBROOT_USER} -p${DBROOT_PASS} -h ${MYBB_DATABASE_HOST} -P ${MYBB_DATABASE_PORT} -e "DROP DATABASE test"
mysql -u ${DBROOT_USER} -p${DBROOT_PASS} -h ${MYBB_DATABASE_HOST} -P ${MYBB_DATABASE_PORT} -e "FLUSH PRIVILEGES"
